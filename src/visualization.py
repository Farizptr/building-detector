...
from src.geojson_utils import load_geojson, extract_polygon
from src.tile_utils import create_stitched_image
...
def visualize_polygon_detections(geojson_path, results_data, output_path=None):
    ...
    plt.title(f"Building Detections - {len(results_data['detections'])} Tiles, {results_data['total_buildings']} Buildings")
